...
#   (A) Estados Unidos, 2003-2023   # [CAMBIO] antes 2007; ATUS empieza en 2003
#   (B) Todos los países disponibles, survey >= 2007
# Salidas: IndUSA0723 / DiariesUSA0723 / IndMulti07 / DiariesMulti07
# NOTA: el sufijo "0723" se conserva por compatibilidad con el pipeline, pero las
#       muestras US ahora cubren 2003-2023. El multipaís sigue en survey>=2007.
# ==================================================================================================
...
# ==================================================================================================
# (A) MUESTRA US 2003-2023   # [CAMBIO] filtro de año cambiado 2007 -> 2003
# ==================================================================================================

cat("\n[1/4] Leyendo individuos (haf) - filtrando US 2003+...\n")
...
IndUSA0723 <- dtInd[country == "United States" & survey >= 2003]   # [CAMBIO] 2007 -> 2003
cat("  Individuos US 2003-2023:", nrow(IndUSA0723), "\n")
save(IndUSA0723, file = paste0(OUT_DIR, "IndUSA0723.RData"))
rm(dtInd); gc()

cat("\n[2/4] Leyendo episodios (hef2) - filtrando US 2003+...\n")
...
DiariesUSA0723 <- dtDiaries[country == "United States" & survey >= 2003]   # [CAMBIO] 2007 -> 2003
cat("  Episodios US 2003-2023:", nrow(DiariesUSA0723), "\n")
save(DiariesUSA0723, file = paste0(OUT_DIR, "DiariesUSA0723.RData"))

# ==================================================================================================
# (B) MUESTRA MULTI-PAÍS — TODOS LOS AÑOS DISPONIBLES POR PAÍS  # [CAMBIO] antes survey>=2007
# ==================================================================================================

cat("\n[3/4] Leyendo individuos multi-país (survey >= 2007)...\n")
...
cat("\n[4/4] Leyendo episodios multi-país (survey >= 2007)...\n")
